...
public class MoveSetSelection {
	...
	public void editMoveSet(FullCharacter fChar) {
		setupMoveSetGUI();
		
		//Setting buttons in correct state
		addButton.setEnabled(false);
		removeButton.setEnabled(true);
		doneButton.setEnabled(true);
		
		//Filling list with moves of the character being edited
		cChar = fChar.getCharacter();
		selectedMoves.setListData(fChar.getMoveSet().toNameOfMoves().toArray());
    	selectedMoves.setSelectedIndex(0);
	}

	
	
	private void setupMoveSetGUI() {
		//Big box
				...
				//Fill list with moves (Move to setup moves later)
				if(first) {
					moveName = new String[moves.size()];
				...
				selectedMoves = new JList(nameOfMoves.toArray());
...
//		            		System.out.println(moveList.getSelectedIndex());
//		            		System.out.println(moves.get(moveList.getSelectedIndex()).getName());
		            		moveSet.add(moves.get(moveList.getSelectedIndex()));
				...
				removeButton.addActionListener(new java.awt.event.ActionListener() {
		            ...
		            public void actionPerformed(java.awt.event.ActionEvent evt) {
		            	...
		            	moveSet.remove(selectedMoves.getSelectedIndex());
		            	selectedMoves.setListData(nameOfMoves.toArray());
		            	selectedMoves.setSelectedIndex(0);
...
//		            	}   
		                ...
		                cs.editButton.setVisible(true);
//		                cs.party.setListData(cs.nameOfMembersInParty.toArray());
		                cs.party.setSelectedIndex(0);
		                cs.characterSelect();		                
		                parent.dispose();
